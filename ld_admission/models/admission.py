...
class OpAdmission(models.Model):
    ...
    def open_student(self):
        form_view = self.env.ref('ld_core.view_op_student_form')
        tree_view = self.env.ref('ld_core.view_op_student_tree')
        value = {
    ...
    def get_import_templates(self):
        return [{
            ...
            'template': '/ld_admission/static/xls/op_admission.xls'
        }]
