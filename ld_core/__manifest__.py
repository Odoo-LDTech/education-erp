...

{
    ...
    'qweb': [
        ...
        'static/src/xml/dashboard_ext_ld.xml'
    ],
    'js': [],
    'images': [
        'static/description/ld_core_banner.jpg',
    ],
    'installable': True,
    'auto_install': False,
    'application': True,
    'post_init_hook': '_ld_post_init',
    'assets': {
        'website.assets_frontend': [
            '/ld_core/static/src/scss/main.scss',
        ],
        'web.assets_backend': [
            '/ld_core/static/src/scss/style.scss',
        ],
    },
}
